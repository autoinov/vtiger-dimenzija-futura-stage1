...
try {
    ...
    $campaign->deleteLink('DETAILVIEWBASIC', 'Send Event Invite'); // optional
    $campaign->addLink(
        'DETAILVIEWBASIC',
        'Send Event Invite',
        'index.php?module=Campaigns&action=SendEventToContacts&record=$RECORD$'
    );

    echo "🎉 Button added successfully to Campaign detail view.<br>";
} catch (Exception $e) {
